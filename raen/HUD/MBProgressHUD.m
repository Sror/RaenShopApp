...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        // deprecated CGSize dims = [self.labelText sizeWithFont:self.labelFont];
		CGSize dims = [self.labelText sizeWithAttributes: @{NSFontAttributeName: [UIFont fontWithName:@"HelveticaNeue" size:14]}];
